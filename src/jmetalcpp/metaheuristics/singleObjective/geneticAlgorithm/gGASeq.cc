 ...
 */
gGASeq::gGASeq(Problem *problem) : Algorithm(problem) {
} // gGA
...
//  cout << "Comienza la inicializacion de la poblacion con size " << populationSize << endl;
  ...
  cout << "gGASeq: YA HEMOS HECHO LA INICIALIZACION" << endl;
...
//  cout << "gGA: Maximo de evaluaciones: " << maxEvaluations << endl;
  ...
  while (evaluations < maxEvaluations) {
    ...
    delete offspringPopulation;
     ...
     cout << "gGA: Best objective from this iteration -> " << population->get(0)->getObjective(0) << 
