...
private:
	...
	//Maria 8-5-2017 @brief replace application of abinitio protocol in line 1807
	void jMetal_optimization( ProtocolOP abinitio_protocol, core::pose::Pose & fold_pose );
