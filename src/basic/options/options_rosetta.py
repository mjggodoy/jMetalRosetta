...
#			Option( 'frag_sizes', 'IntegerVector', desc="Fragment file sizes" ),
			...
			Option( 'extra_res_mmCIF', 'FileVector',
					desc=".mmCIF file(s) for component dictionary for residue types (e.g. ligands)"),
			Option( 'load_PDB_components', 'Boolean',
					desc="Use the PDB ligand definitions to load all standard residue descriptions."),
			Option( 'PDB_components_file', 'String',
					default="chemical/components.cif",
					desc="The CIF file from which to load the PDB component definitions. "
								"(An example can be found at http://www.wwpdb.org/data/ccd"),
			...
			Option( 'override_rot_lib_path', 'PathVector',
					desc="if rotamer libraries are found in this directory, prioritize them and not others" ),
...
#		),
	...
	Option_Group( 'score',
		...
		Option( 'weights', 'String', desc="Name of weights file (without extension .wts)" , default="talaris2014" ),
		...
		Option( 'pack_weights', 'String', desc="Name of packing weights file (without extension .wts)" , default="talaris2014" ),
...
#		Option( 'minimizer_tol', 'Real', desc="tolerance for minimization", default='.0001'),
	...
	Option_Group( 'cyclic_peptide',
		...
		Option( 'MPI_processes_by_level', 'IntegerVector', desc="The number of processes at each level of the parallel communications hierarchy, used only by the MPI version.  For example, '1 10 100' would mean that one emperor would talk to 10 masters, which would talk to 100 slaves (implying that each master is assigned 100 slaves).  Similarly, '1 100' would mean that one master would talk directly to 100 slaves.  Required for the MPI version." ),
		...
		Option( 'MPI_stop_after_time', 'Integer', desc="If this option is used, the emperor node will send a stop signal after an elapsed period of time, given in seconds.  Slaves jobs currently running will continue, but intermediate masters will not assign any more work.  Useful on HPC clusters with time limits, to ensure that jobs completed are collected at the end.  Unused if not specified." ),
		Option( 'MPI_pnear_lambda', 'Real', desc="In MPI mode a goodness-of-funnel metric is automatically calculated at the end (PNear).  This value may be thought of as the probability, from 0 to 1, of the peptide being in the target conformation at any given time.  The parameter lambda controls the bredth of the Gaussian (in RMSD units -- Angstroms) that is used to determine whether a state is native-like or not.  Default 0.5 A.", default='0.5'),
		Option( 'MPI_pnear_kbt', 'Real', desc="In MPI mode a goodness-of-funnel metric is automatically calculated at the end (PNear).  This value may be thought of as the probability, from 0 to 1, of the peptide being in the target conformation at any given time.  The parameter kbt is the Boltzmann temperature that determines the extent to which higher energy states are likely to be sampled.  Default 1.0 Rosetta energy units.", default='1.0'),
	), # -cyclic_peptide
       ...
       Option( 'refine_silent_file', 'String', desc= "Name of the silent file to be refined.",default="" ),
		   ...
		   Option_Group( 'out',
		      ...
		      Option( 'binary_output', 'Boolean', desc= "force output to binary rna silentstruct",default= 'false' ),
			    ...
			    Option( 'output_jump_res', 'IntegerVector', desc= "output jump information for these two residues", default='' ),
...
#			Option( 'erraser', 'Boolean', desc= "Use KIC sampling", default='true' ),
		  ...
		  Option( 'checkpointing_frequency', 'Integer', desc="How often should we output checkpoint files?", default='0'),
		  Option_Group( 'csa',
