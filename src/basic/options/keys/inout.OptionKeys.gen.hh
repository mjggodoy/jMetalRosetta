...
namespace inout { extern BooleanOptionKey const skip_connect_info; }
namespace inout { extern BooleanOptionKey const write_all_connect_info; }
...
namespace inout { namespace dbms { extern PathOptionKey const path; } }
