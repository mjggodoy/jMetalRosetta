...
namespace in { BooleanOptionKey const guarantee_no_DNA( "in:guarantee_no_DNA" );  }
...
namespace in { BooleanOptionKey const prevent_auto_setup_metal_bb_variants( "in:prevent_auto_setup_metal_bb_variants" );  }
...
namespace in { StringVectorOptionKey const name3_property_codes( "in:name3_property_codes" );  }
namespace in { StringVectorOptionKey const alternate_3_letter_codes( "in:alternate_3_letter_codes" );  }
namespace in { BooleanOptionKey const only_chairs( "in:only_chairs" );  }
...
namespace in { namespace path { PathOptionKey const database_cache_dir( "in:path:database_cache_dir" );  } }
...
namespace in { namespace file { FileOptionKey const job_definition_file( "in:file:job_definition_file" );  } }
...
namespace in { namespace file { FileVectorOptionKey const extra_res_mmCIF( "in:file:extra_res_mmCIF" );  } }
namespace in { namespace file { BooleanOptionKey const load_PDB_components( "in:file:load_PDB_components" );  } }
namespace in { namespace file { StringOptionKey const PDB_components_file( "in:file:PDB_components_file" );  } }
...
namespace in { namespace file { PathVectorOptionKey const override_rot_lib_path( "in:file:override_rot_lib_path" );  } }
...
namespace inout { BooleanOptionKey const skip_connect_info( "inout:skip_connect_info" );  }
namespace inout { BooleanOptionKey const write_all_connect_info( "inout:write_all_connect_info" );  }
...
namespace out { BooleanOptionKey const mmCIF( "out:mmCIF" );  }
namespace out { BooleanOptionKey const mmCIF_gz( "out:mmCIF_gz" );  }
...
namespace out { BooleanOptionKey const save_times( "out:save_times" );  }
...
namespace out { namespace file { BooleanOptionKey const no_chainend_ter( "out:file:no_chainend_ter" );  } }
...
namespace out { namespace file { BooleanOptionKey const output_secondary_structure( "out:file:output_secondary_structure" );  } }
namespace out { namespace file { BooleanOptionKey const do_not_autoassign_SS( "out:file:do_not_autoassign_SS" );  } }
...
namespace out { namespace file { BooleanOptionKey const use_pdb_format_HETNAM_records( "out:file:use_pdb_format_HETNAM_records" );  } }
namespace out { namespace file { BooleanOptionKey const write_pdb_parametric_info( "out:file:write_pdb_parametric_info" );  } }
namespace out { namespace file { BooleanOptionKey const output_pose_energies_table( "out:file:output_pose_energies_table" );  } }
namespace out { namespace file { BooleanOptionKey const output_pose_cache_data( "out:file:output_pose_cache_data" );  } }
namespace out { namespace file { BooleanOptionKey const output_pose_fold_tree( "out:file:output_pose_fold_tree" );  } }
