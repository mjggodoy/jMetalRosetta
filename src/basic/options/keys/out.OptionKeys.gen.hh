...
namespace out { extern BooleanOptionKey const membrane_pdb; }
namespace out { extern RealOptionKey const membrane_pdb_thickness; }
namespace out { extern BooleanOptionKey const mmCIF; }
namespace out { extern BooleanOptionKey const mmCIF_gz; }
...
namespace out { extern BooleanOptionKey const show_unused_options; }
...
namespace out { extern BooleanOptionKey const save_times; }
...
namespace out { namespace file { extern StringOptionKey const scorefile_format; } }
...
namespace out { namespace file { extern BooleanOptionKey const output_virtual_zero_occ; } }
namespace out { namespace file { extern BooleanOptionKey const no_chainend_ter; } }
...
namespace out { namespace file { extern BooleanOptionKey const output_secondary_structure; } }
namespace out { namespace file { extern BooleanOptionKey const do_not_autoassign_SS; } }
...
namespace out { namespace file { extern BooleanOptionKey const use_pdb_format_HETNAM_records; } }
namespace out { namespace file { extern BooleanOptionKey const write_pdb_parametric_info; } }
namespace out { namespace file { extern BooleanOptionKey const output_pose_energies_table; } }
namespace out { namespace file { extern BooleanOptionKey const output_pose_cache_data; } }
namespace out { namespace file { extern BooleanOptionKey const output_pose_fold_tree; } }
namespace out { namespace file { extern BooleanOptionKey const cif_extra_data_separate_file; } }
...
namespace out { namespace file { extern BooleanOptionKey const no_extra_sdf_data; } }
namespace out { namespace file { extern BooleanOptionKey const no_scores_in_pdb; } }
...
namespace out { namespace path { extern PathOptionKey const db; } }
...
namespace out { namespace path { extern PathOptionKey const mmCIF; } }
