...
namespace pocket_grid { extern BooleanOptionKey const pocket_limit_exemplar_color; }
namespace pocket_grid { extern BooleanOptionKey const pocket_limit_small_exemplars; }
...
namespace pocket_grid { extern BooleanOptionKey const dump_pocketGrid; }
namespace pocket_grid { extern BooleanOptionKey const dump_Grid; }
...
namespace pocket_grid { extern BooleanOptionKey const dump_espGrid; }
namespace pocket_grid { extern BooleanOptionKey const dump_connollySurface; }
namespace pocket_grid { extern RealOptionKey const esp_buffer_dist; }
namespace pocket_grid { extern BooleanOptionKey const round_pocketGrid_center; }
