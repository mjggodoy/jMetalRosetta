...
namespace parser { extern StringVectorOptionKey const info; }
namespace parser { extern StringOptionKey const output_schema; }
...
namespace parser { extern BooleanOptionKey const validate_and_exit; }
