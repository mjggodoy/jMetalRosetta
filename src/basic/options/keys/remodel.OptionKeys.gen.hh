...
namespace remodel { extern BooleanOptionKey const cst_fa_only; }
...
namespace remodel { extern IntegerOptionKey const reroot_tree; }
...
namespace remodel { extern StringOptionKey const coreAA; }
namespace remodel { extern StringOptionKey const boundaryAA; }
namespace remodel { extern StringOptionKey const surfaceAA; }
namespace remodel { extern BooleanOptionKey const design_around_ligand; }
namespace remodel { extern BooleanOptionKey const move_ligand; }
...
namespace remodel { extern RealVectorOptionKey const filter_rise; }
namespace remodel { extern RealVectorOptionKey const filter_radius; }
namespace remodel { extern RealVectorOptionKey const filter_omega; }
...
namespace remodel { namespace staged_sampling { extern StringOptionKey const starting_non_canonical; } }
...
namespace remodel { namespace staged_sampling { extern BooleanOptionKey const fa_mode; } }
namespace remodel { namespace staged_sampling { extern BooleanOptionKey const fa_relax_moves; } }
namespace remodel { namespace staged_sampling { extern BooleanOptionKey const sym_move; } }
namespace remodel { namespace staged_sampling { extern BooleanOptionKey const loop_btw_parametric_components; } }
namespace remodel { namespace staged_sampling { extern BooleanOptionKey const pre_centroid; } }
...
namespace remodel { namespace domainFusion { extern FileOptionKey const insert_segment2_from_pdb; } }
...
namespace remodel { namespace design { extern BooleanOptionKey const include_current; } }
...
namespace remodel { namespace RemodelLoopMover { extern FileOptionKey const set_segment; } }
...
namespace remodel { namespace RemodelLoopMover { extern RealOptionKey const threshold_for_boost_closure; } }
namespace remodel { namespace RemodelLoopMover { extern IntegerOptionKey const force_cutting_index; } }
