...
namespace motifs { extern StringOptionKey const file_prefix; }
namespace motifs { extern StringOptionKey const build_residue_file; }
namespace motifs { extern StringOptionKey const motif_flexible_loop_file; }
namespace motifs { extern StringOptionKey const residue_trim_file; }
