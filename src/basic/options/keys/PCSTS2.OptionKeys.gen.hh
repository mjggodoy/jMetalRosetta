...
/// @file   basic/options/keys/PCSTS2.OptionKeys.gen.hh
/// @brief  basic::options::OptionKeys collection
/// @author Stuart G. Mentzer (Stuart_Mentzer@objexx.com)
/// @author James M. Thompson (tex@u.washington.edu)

#ifndef INCLUDED_basic_options_keys_PCSTS2_OptionKeys_gen_HH
#define INCLUDED_basic_options_keys_PCSTS2_OptionKeys_gen_HH
