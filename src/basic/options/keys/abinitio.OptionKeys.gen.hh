...
namespace abinitio { extern BooleanOptionKey const use_loophash_filter; }
namespace abinitio { extern RealOptionKey const loophash_filter_acceptance_rate; }
...
namespace abinitio { extern RealOptionKey const de_crParameter; }
namespace abinitio { extern RealOptionKey const de_fParameter; }
...
namespace abinitio { extern BooleanOptionKey const cyclic_peptide; }
...
namespace abinitio { extern BooleanOptionKey const apply_end_bias; }
...
namespace abinitio { namespace star { extern RealOptionKey const initial_dist_cutoff; } }
