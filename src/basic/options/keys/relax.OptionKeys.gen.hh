...
namespace relax { extern BooleanOptionKey const cyclic_peptide; }
namespace relax { namespace range { extern BooleanOptionKey const range; } }
namespace relax { namespace range { extern BooleanOptionKey const set_tm_helical; } }
namespace relax { namespace range { extern RealOptionKey const kT; } }
namespace relax { namespace range { extern RealOptionKey const angle_max; } }
namespace relax { namespace range { extern StringOptionKey const nmoves; } }
namespace relax { namespace range { extern BooleanOptionKey const spherical_wave; } }
namespace relax { namespace range { extern BooleanOptionKey const repack_again; } }
namespace relax { namespace range { extern IntegerOptionKey const cycles; } }
namespace relax { namespace range { extern IntegerOptionKey const min_cycles; } }
namespace relax { namespace range { extern BooleanOptionKey const idealize; } }
namespace relax { namespace range { extern BooleanOptionKey const skip_relax; } }
