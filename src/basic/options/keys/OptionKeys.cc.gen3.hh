...
namespace constraints { BooleanVectorOptionKey const force_pdb_info_mapping( "constraints:force_pdb_info_mapping" );  }
...
namespace corrections { BooleanOptionKey const beta_cart( "corrections:beta_cart" );  }
namespace corrections { BooleanOptionKey const beta_nov16( "corrections:beta_nov16" );  }
namespace corrections { BooleanOptionKey const beta_nov16_cart( "corrections:beta_nov16_cart" );  }
namespace corrections { BooleanOptionKey const beta_nov15( "corrections:beta_nov15" );  }
namespace corrections { BooleanOptionKey const beta_nov15_cart( "corrections:beta_nov15_cart" );  }
...
namespace corrections { BooleanOptionKey const beta_patch( "corrections:beta_patch" );  }
namespace corrections { BooleanOptionKey const beta_nov15_patch( "corrections:beta_nov15_patch" );  }
...
namespace corrections { namespace score { FileOptionKey const rama_pp_map( "corrections:score:rama_pp_map" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_average_L_flat( "corrections:score:rama_map_average_L_flat" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_sym_average_L_flat( "corrections:score:rama_map_sym_average_L_flat" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_sym_gly_flat( "corrections:score:rama_map_sym_gly_flat" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_sym_pro_flat( "corrections:score:rama_map_sym_pro_flat" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_average_L_flat_stringent( "corrections:score:rama_map_average_L_flat_stringent" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_sym_average_L_flat_stringent( "corrections:score:rama_map_sym_average_L_flat_stringent" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_sym_gly_flat_stringent( "corrections:score:rama_map_sym_gly_flat_stringent" );  } }
namespace corrections { namespace score { FileOptionKey const rama_map_sym_pro_flat_stringent( "corrections:score:rama_map_sym_pro_flat_stringent" );  } }
namespace corrections { namespace score { BooleanOptionKey const rama_prepro_steep( "corrections:score:rama_prepro_steep" );  } }
namespace corrections { namespace score { BooleanOptionKey const rama_prepro_nobidentate( "corrections:score:rama_prepro_nobidentate" );  } }
...
namespace corrections { namespace score { BooleanOptionKey const hb_cen_soft( "corrections:score:hb_cen_soft" );  } }
...
namespace evaluation { StringOptionKey const rms_type( "evaluation:rms_type" );  }
...
namespace loops { IntegerOptionKey const minimize_max_iter( "loops:minimize_max_iter" );  }
