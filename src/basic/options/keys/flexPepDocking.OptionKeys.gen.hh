...
namespace flexPepDocking { extern BooleanOptionKey const place_peptide_on_binding_site; }
namespace flexPepDocking { extern IntegerOptionKey const sample_pcs; }
namespace flexPepDocking { extern BooleanOptionKey const SlideIntoContact; }
namespace flexPepDocking { extern BooleanOptionKey const recalculate_foldtree; }
