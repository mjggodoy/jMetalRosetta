...
namespace run { extern BooleanOptionKey const msd_job_dist; }
namespace run { extern BooleanOptionKey const msd_randomize; }
...
namespace run { extern RealOptionKey const maxruntime_bufferfactor; }
...
namespace run { extern BooleanOptionKey const update_pymol_on_energy_changes_only; }
namespace run { extern BooleanOptionKey const update_pymol_on_conformation_changes_only; }
namespace run { extern BooleanOptionKey const keep_pymol_simulation_history; }
namespace run { extern RealOptionKey const insert_disulfide_constraint_weight; }
