...
namespace cm { namespace hybridize { extern IntegerOptionKey const add_non_init_chunks; } }
...
namespace cm { namespace hybridize { extern BooleanOptionKey const include_loop_ss_chunks; } }
