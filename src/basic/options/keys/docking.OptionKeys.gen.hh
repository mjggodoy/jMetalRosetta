...
namespace docking { extern RealVectorOptionKey const tilt; }
namespace docking { extern StringOptionKey const tilt1_center; }
namespace docking { extern StringOptionKey const tilt2_center; }
...
namespace docking { namespace ligand { extern RealOptionKey const ligand_ensemble; } }
