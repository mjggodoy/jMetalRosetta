...
namespace pose_metrics { namespace shobuns { extern BooleanOptionKey const shobuns; } }
namespace pose_metrics { namespace shobuns { extern StringOptionKey const tgt_amino; } }
namespace pose_metrics { namespace shobuns { extern StringOptionKey const tgt_atom; } }
namespace pose_metrics { namespace shobuns { extern FileOptionKey const tgt_res; } }
namespace pose_metrics { namespace shobuns { extern RealOptionKey const sho_cutoff; } }
