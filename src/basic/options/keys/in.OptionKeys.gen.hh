...
namespace in { extern BooleanOptionKey const guarantee_no_DNA; }
...
namespace in { extern BooleanOptionKey const include_lipids; }
...
namespace in { extern BooleanOptionKey const constraints_from_link_records; }
namespace in { extern BooleanOptionKey const auto_setup_metals; }
namespace in { extern BooleanOptionKey const prevent_auto_setup_metal_bb_variants; }
...
namespace in { extern StringVectorOptionKey const name3_property_codes; }
namespace in { extern StringVectorOptionKey const alternate_3_letter_codes; }
namespace in { extern BooleanOptionKey const only_chairs; }
...
namespace in { namespace path { extern PathOptionKey const database_cache_dir; } }
...
namespace in { namespace file { extern FileOptionKey const job_definition_file; } }
...
namespace in { namespace file { extern StringVectorOptionKey const remap_pdb_atom_names_for; } }
...
namespace in { namespace file { extern FileVectorOptionKey const extra_res_mmCIF; } }
namespace in { namespace file { extern BooleanOptionKey const load_PDB_components; } }
namespace in { namespace file { extern StringOptionKey const PDB_components_file; } }
...
namespace in { namespace file { extern PathVectorOptionKey const extra_rot_lib_path; } }
namespace in { namespace file { extern PathVectorOptionKey const override_rot_lib_path; } }
...
namespace in { namespace file { extern BooleanOptionKey const force_silent_bitflip_on_read; } }
...
namespace in { namespace file { extern BooleanOptionKey const assign_gasteiger_atom_types; } }
...
namespace in { namespace file { extern FileOptionKey const binary_chk; } }
...
namespace in { namespace file { extern ResidueChainVectorOptionKey const input_res; } }
