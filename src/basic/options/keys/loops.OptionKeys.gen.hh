...
namespace loops { extern BooleanOptionKey const skip_initial_loop_build; }
...
namespace loops { extern IntegerOptionKey const perturb_outer_cycles; }
namespace loops { extern IntegerOptionKey const refine_outer_cycles; }
...
namespace loops { extern IntegerOptionKey const minimize_max_iter; }
...
namespace loops { namespace ccd { extern BooleanOptionKey const ccd; } }
namespace loops { namespace ccd { extern RealOptionKey const max_rama_score_increase; } }
namespace loops { namespace ccd { extern RealVectorOptionKey const max_torsion_delta_per_move; } }
namespace loops { namespace ccd { extern RealVectorOptionKey const max_torsion_delta; } }
namespace loops { namespace ccd { extern RealOptionKey const tolerance; } }
namespace loops { namespace ccd { extern IntegerOptionKey const max_cycles; } }
namespace loops { namespace ccd { extern BooleanOptionKey const check_rama_scores; } }
namespace loops { namespace ccd { extern BooleanOptionKey const rama_2b; } }
namespace loops { namespace ccd { extern RealOptionKey const temperature; } }
