...
namespace cluster { extern BooleanOptionKey const skip_align; }
namespace cluster { extern IntegerOptionKey const max_rms_matrix; }
namespace cluster { extern BooleanOptionKey const rna_P; }
...
namespace cluster { extern BooleanOptionKey const write_centers; }
